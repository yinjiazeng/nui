...
Nui.define(function(require){
    this.imports('../assets/components/dropdown/index');

    var Component = require('../core/component');
    var Placeholder = require('./placeholder');
    var Search = require('./search');

    var Dropdown = this.extend(Component, {
        _static:{
        ...
        _template:
            '<div class="nui-dropdown">'+
                '<div class="con-dropdown-wrap">'+
                    '<div class="con-dropdown-combo">'+
                        '<%tpl%>'+
                        '<div class="con-dropdown-edit">'+
                            '<input type="text" class="con-dropdown-input">'+
                        '</div>'+
                    '</div>'+
                    '<div class="con-dropdown-adorn">'+
                        '<span class="con-dropdown-arrow">▼</span>'+
                    '</div>'+
                '</div>'+
            '</div>',
        _exec:function(){
            if(this._getTarget()){
                ...
                Search({
                    ...
                    nullable:true,
                    tag:{
                        container:that.element.find('.con-dropdown-combo'),
                        scroll:that.element.find('.con-dropdown-wrap'),
                        multiple:multi,
                        backspace:true
                    },
                    size:{
