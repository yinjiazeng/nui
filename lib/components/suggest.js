        ...
        _template:{
            ...
            tag:
                '<span class="nui-tag">'+
                    ...
                    '<%if fields?? && fields%>'+
                        '<%each fields%>'+
                            '<input type="hidden" class="suggest-hidden" name="<%$index%>" value="<%$value%>">'+
                        '<%/each%>'+
                    '<%/if%>'+
                '</span>'
        },
        ...
        _initTemplate:function(name){
            ...
            if(typeof content !== 'string'){
                if(name === 'item' && opts.field){
                    content = '<li class="suggest-item<%selected($data)%>" data-index="<%$index%>"><%$data["'+ opts.field +'"]??%></li>'
                }
                else{
                    content = ''
                }
                ...
                content = '<li class="suggest-item<%selected($data)%>" data-index="<%$index%>">'+ content +'</li>'
            }
