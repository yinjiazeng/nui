...
__define('src/components/suggest',['src/core/component'], function(component){
...
__define('pages/components/suggest/data',function(require,imports,renders,extend,exports){
	var module=this;
