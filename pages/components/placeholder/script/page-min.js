...
;(function (__define__) {
    ...
    __define__('./script/page', ['src/components/placeholder', 'src/core/events'], function (placeholder, events) {
        events({
            events: {
                'focus :text': function focusText(e, elem) {
                    elem.placeholder({
                        text: '19920604',
                        restore: false
                    });
                },
                'blur :text': function blurText(e, elem) {
