...
;(function (__define) {
    ...
    __define('./script/page', ['src/components/layer/layer', 'src/core/events'], function (layer, events) {
        ...
        return events({
            element: document,
            events: {
                'click .j-demo': function clickJDemo() {
                    layer({
                ...
                'click .j-position': function clickJPosition() {
                    layer({
                        content: renders('' + '' + '<div style="padding:15px 20px; line-height:20px;">' + '' + '<p>消息标题1</p>' + '' + '<p>消息标题2</p>' + '' + '<p>消息标题3</p>' + '' + '</div>' + '' + ''),
                        title: '系统消息',
                        width: 280,
                        isMask: false,
                        cancel: {
